...
export const SALES_ITEM_AVAILABLE_QTY = (id, productionId) => `${domain}/sales/${id}/product/${productionId}/production/availability`;
export const SALES_DETAIL_BY_PRODUCT_ID = (id, cId, salesId) => `${domain}/sales/${salesId}/product/${id}/customer/${cId}`;
...
export const PURCHASE_DETAILS_BY_PRODUCT_ID = (purchaseId, productId, sId) => `${domain}/purchase/${purchaseId}/product/${productId}/supplier/${sId}`;
// Return API
...
export const AVAILABLE_PURCHASE_PRODUCT_QTY = (purchaseId, productId, sId) => `${domain}/material/purchase/${purchaseId}/product/${productId}/supplier/${sId}`;
...
export const PRODUCTION_DETAIL_BY_PRODUCT_ID = (id, batchNo) => `${domain}/production/product/${id}/batch/${batchNo}`;
...
export const USED_MATERIAL_DETAIL_BY_PRODUCT_ID = (productId, purchaseId, id) => `${domain}/material/product/${productId}/production/${id}/purchase/${purchaseId}`;
...
export const PRODUCT_HISTORY = (id, type, supId, batchNo) => `${domain}/report/timeline/${id}/product/${type}/${supId}/${batchNo}`;
...
export const STOCK_REPORT_BY_TYPE = `${domain}/report/product/stock/details`;

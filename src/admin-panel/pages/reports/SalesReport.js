...
const SalesReport = () => {
  ...
  return (
    <Grid container spacing={1}>
      ...
      <Grid item sm={12}>
        <SingleBarChart title="Sales Report" filteredData={filteredData} />
      </Grid>
      <Grid item xs={12} sm={6}>
        <PeiChart title="Product Sales by Unit" PeiData={PeiData} />
      </Grid>
      <Grid item xs={12} sm={6} >
        <ProgressBarChart title="Product Sales by quantity" productData={productData} />
      </Grid>
      <Grid item xs={12}>

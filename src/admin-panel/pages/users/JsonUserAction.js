...
import { departmentsData, rolesData } from '../../json-data/UserJson'


const JsonUserAction = ({ onClose,updateRecord,  title, selectedData = {}, readOnly = false }) => {
    ...
    console.log("formsData", formsData.profile);
    ...
    const submitAction = () => {
        ...
        updateRecord(selectedData.id, formsData);
    }

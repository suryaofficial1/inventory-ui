...
const ExcelReportAction = async (salesData, formsData) => {
    ...
    // 🎯 Column Headers
    const headers = ["Date", "Sales Name","Customer Name", "Product Name", "Qty", "Sales Price", "Total Sales Amount"];
    ...
    worksheet.columns = [
        ...
        { key: "salesName", width: 20, alignment: { horizontal: "left" } },
        ...
        { key: "salesPrice", width: 20, alignment: { horizontal: "center" }, numFmt: "0.00" },
    ...
    salesData.forEach(row => {
        const rowData = worksheet.addRow({
            ...
            totalSales: Number(row.qty) * Number(row.salesPrice)
        });
